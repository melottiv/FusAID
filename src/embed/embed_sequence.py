...
if __name__ == "__main__":
    ...
    print(f"Sequence embeddings saved in {args.outfile}")
...
python embed_sequence.py \
    ...
    --outfile /homes/vmelotti/project/data/embeddings/sequence_decider_positive.npz \
    --sequence_column sequence
    
python embed_sequence.py \
    --infile /homes/vmelotti/project/data/raw/data_SRR.pkl \
    --outfile /homes/vmelotti/project/data/embeddings/sequence_SRR.npz
